        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title">Drill-Down</h3>
                            <div class="table-responsive">
                               <?php 
                                    ...
                                    $result = mysqli_query($bdd, "SELECT tblorders.OrderDate , tblorders.ShipCity, tblproducts.ProductName, SUM(tblorderdetails.Quantity) AS Quantity
