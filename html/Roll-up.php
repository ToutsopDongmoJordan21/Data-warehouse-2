                        ...
                        <div class="white-box">
                            ...
                            <div class="table-responsive">
                                 <?php 
                                    ...
                                    $result = mysqli_query($bdd, "SELECT  tblorders.OrderDate, tblorders.ShipCountry, tblproducts.ProductName, SUM(tblorderdetails.Quantity)
                                    ...
                                    <tr class="data-heading">
                                        ...
                                        <th>ShipCountry</th>
                                        <th>ProductName</th>
                                        <th>SUM(tblorderdetails.Quantity)</th>                                                                            
                                    </tr>
                                    </thead>';  
                                            ...
                                            echo "<tr>";
                                                 ...
                                                 echo "<td><b>".$row['SUM(tblorderdetails.Quantity)']."</td>";
                                            echo "</tr>";
                                            echo "</thead>";
                                               }
                                               echo "</table>";
